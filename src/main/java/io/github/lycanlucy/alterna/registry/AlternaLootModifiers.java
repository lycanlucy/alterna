...
public class AlternaLootModifiers {
    ...
    public static final DeferredHolder<MapCodec<? extends IGlobalLootModifier>, MapCodec<ReplaceItemLootModifier>> REPLACE_ITEM = LOOT_MODIFIERS.register("replace_item", () -> ReplaceItemLootModifier.CODEC);
