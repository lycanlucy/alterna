...
public class RiverSalmonModel extends ReplacedSalmonModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Alterna.id("river_salmon"), "main");
