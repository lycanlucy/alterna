...
public class OceanSalmonModel extends ReplacedSalmonModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Alterna.id("ocean_salmon"), "main");
