...
public class ItemRackRenderer implements BlockEntityRenderer<ItemRackBlockEntity> {
    ...
    @Override
    public void render(ItemRackBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
