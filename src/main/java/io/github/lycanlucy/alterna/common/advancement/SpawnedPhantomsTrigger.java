...
public class SpawnedPhantomsTrigger extends SimpleCriterionTrigger<SpawnedPhantomsTrigger.TriggerInstance> {
    @Override
    ...
    public record TriggerInstance(
        ...
        public static Criterion<TriggerInstance> spawnedPhantoms() {
            return AlternaTriggers.SPAWNED_PHANTOMS.get().createCriterion(new TriggerInstance(Optional.empty()));
        }
    }
}