...
import io.github.lycanlucy.alterna.common.loot.AlternaLootTables;
...
public class AlternaGLMProvider extends GlobalLootModifierProvider {
    public AlternaGLMProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
